    ...
    <body>
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a href="AdminCRUD.jsp" class="menu-list">
                ...
                <li>
                    <a href="AdminRoomRegister.jsp" class="menu-list">
                ...
                <li>
                    <a href=" AdminProfile.jsp?email=<c:out value='${email}'/> " class="menu-list">
                ...
                <!-- logout button -->
                <li>
                    <a href="AdminLogoutServlet" class="menu-list logout">
